(function () {
  ...
  function switchTarget() {
    ...
    var isChinese = pathname.indexOf('/zh-CN/') !== -1 || pathname.endsWith('/zh-CN');
  ...
  function addLanguageSwitch() {
    ...
    var pathname = window.location.pathname;
    var isChinese = pathname.indexOf('/zh-CN/') !== -1 || pathname.endsWith('/zh-CN');
    var rightButtons = document.querySelector('#menu-bar .right-buttons') || document.querySelector('#menu-bar');
    if (!rightButtons) {
      return;
    }
    ...
    link.innerHTML = '<span class="language-switch__icon" aria-hidden="true">🌐</span><span class="language-switch__label">' + (isChinese ? 'EN' : '中文') + '</span>';
